  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.signUp}>
        ...
        <TouchableOpacity style={styles.phoneSign}>
          <View>
            <Text style={{color: '#E94057'}}>Use phone number</Text>
          </View>
        </TouchableOpacity>
      </View>
      <View style={styles.line}>
        <View style={{flexDirection: 'row'}}>
          ...
          <Text style={{alignSelf: 'center', paddingHorizontal: 14, fontSize: 12,}}>
            or sign up with
          </Text>
          <View style={styles.lineSep} />
        </View>
        <View
          ...
          <TouchableOpacity
            ...
            <Icons name="facebook-official" size={32} style={styles.iconItem} />
          </TouchableOpacity>
          <TouchableOpacity style={styles.icons}>
            <Icons name="google" size={32} style={styles.iconItem} />
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.icons, {marginLeft: 20, marginRight: 32}]}>
            <Icons name="apple" size={32} style={styles.iconItem} />
          </TouchableOpacity>
        </View>
